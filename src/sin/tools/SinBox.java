 ...
 */
public class SinBox extends Box {
     ...
     */
    public void SetFBAlpha(FloatBuffer which, float alpha) {
        VertexBuffer buff = this.getBuffer(VertexBuffer.Type.Color);
    ...
    public SinBox(float x, float y, float z) {
        super();
     ...
     * @param z the size of the box along the z axis, in both directions.
     */
    public SinBox(Vector3f center, float x, float y, float z) {
        super();
     ...
     */
    public SinBox(Vector3f min, Vector3f max) {
        super();
